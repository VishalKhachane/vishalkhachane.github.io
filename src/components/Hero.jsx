  ...
  return (
    <section id="home" className="relative md:pt-44 pt-28 pb-16 bg-white dark:bg-darklight bg-cover transition-colors duration-300 overflow-hidden">
      ...
      <div className="container mx-auto max-w-6xl px-4 grid grid-cols-12 gap-8 relative z-10">
        ...
        {/* Text Content */}
        <div className="md:col-span-7 col-span-12 p-4 space-y-6 flex flex-col items-center text-center justify-center order-2 md:order-1">
          ...
          <h1 className="text-gray-900 dark:text-white font-extrabold text-4xl sm:text-5xl md:text-[3.5rem] leading-tight tracking-tight animate-float-up opacity-0" style={{ animationDelay: '0.3s' }}>
          ...
          <p className="text-gray-800 dark:text-gray-100 text-lg sm:text-xl font-bold max-w-lg leading-relaxed animate-float-up opacity-0" style={{ animationDelay: '0.5s' }}>
          ...
          <div className="flex flex-wrap justify-center items-center gap-4 pt-2 animate-float-up opacity-0" style={{ animationDelay: '0.7s' }}>
            <a
              href="#projects"
              className="py-3 px-8 bg-primary text-white font-bold rounded-lg hover:bg-blue-700 transition duration-300 shadow-lg flex items-center gap-2 hover:scale-105"
            >
              View My Work
            ...
            <a
              href="#contact"
              className="py-3 px-8 bg-transparent text-gray-900 dark:text-white font-bold border-2 border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition duration-300 hover:scale-105"
            >
              Let's Talk
            </a>
          </div>
          
          <div className="flex flex-wrap justify-center items-center mt-8 gap-8 sm:gap-10 pt-6 border-t border-gray-300 dark:border-gray-700 w-full max-w-lg animate-float-up opacity-0" style={{ animationDelay: '0.9s' }}>
