...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-[#020b1e] via-[#051532] to-[#0a2350] pt-16 pb-8 border-t-0">
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-12">
          ...
          <div className="flex gap-4">
            ...
            <a href={personalInfo.socials.github} target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white hover:scale-110 transition-all">
